...
dat$Y |> 
  ...
  scale_color_discrete(labels = c("Red", "Green", "Blue")) + 
  theme_bw() +
...
plot_rgb <- dat$Y |> 
  ...
  geom_point(aes(x = x, y = y, 
                 size = w, 
                 color = color, 
                 label0 = non_spat_group, label1 = r_par1, label2 = g_par2, label3 = b_par3)) +
...
#ggplotly(plot_rgb, tooltip = c("non_spat_group", "r_par1", "g_par2", "b_par3", "color"))
